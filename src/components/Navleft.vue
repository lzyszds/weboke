    ...
    <div class="bg-white h-full w-full relative">
      ...
      <div class="pb-10 headIcon">
        <p class="w-full pt-11">
          <img
            :src="navData.headP"
            class="w-40 h-40 m-auto rounded-full shadow-image"
            alt=""
          />
        </p>
        <p
      ...
      <div class="mb-8">
        ...
        <ul class="text-xl font-normal">
          <router-link
            tag="li"
            v-for="(item, index) in navData.Navigation"
            :key="index"
            :to="item.url"
            class="
              flex
          ...
          >
            <div
              class="mr-7 ml-10 w-8 h-8 images"
      ...
      <div class="mb-8">
        ...
        <ul class="text-xl font-normal">
          <router-link
            tag="li"
            v-for="(item, index) in navData.form"
            :key="index"
            :to="item.url"
            class="
              flex
      ...
      <!-- 底部导航 -->
      <div
        class="fixed bottom-0 flex flex-nowrap w-96 p-1 text-xs my-2 shadow-top"
      >
        <el-tooltip
          class="item p-0 flex-1 text-center cursor-pointer"
          effect="dark"
          content="后台管理"
          placement="top"
        >
          <div class="border-0">
            <div
              class="m-auto my-2 w-8 h-8 py-2 images"
